...
func init() {
	dsn := "root:lcc123456@tcp(127.0.0.1:3306)/golang_db?charset=utf8mb4&parseTime=True&loc=Local"
...
func (mgr *manager) Resiter(user *model.User) {
	mgr.db.Create(user)
}
